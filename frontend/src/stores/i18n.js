...
const MESSAGES = {
  en: {
    ...
    nav: {
      ...
      technologyAios: 'AIOS Platform',
      technologyNemo: 'NEMO ONE',
      companyAbout: 'About',
      companyTeam: 'Team',
    ...
    hero: {
      ...
      deviceAlt: 'DAIL product showcase',
      badge1: 'Nemo One',
      badge2: 'AIOS Platform',
      badge3: 'vibebara',
      feature1: 'Nemo One Appliance · Local AI Infrastructure',
      feature2: 'AIOS Platform · Enterprise AI Development & Operations',
      feature3: 'vibebara · Skill Collaboration Platform',
    },
    dailOverview: {
      ...
      statement:
        '—Intelligence becomes the organization’s own capability; built end to end, delivered once, evolving always',
      linksAria: 'Explore more about DAIL',
      linkTechnology: 'Technology',
      linkTechnologyDesc: 'Explore DAIL’s AI-native technology system',
      linkCases: 'Industry cases',
      linkCasesDesc: 'See how DAIL works across real industries',
      linkTeam: 'Team',
      linkTeamDesc: 'Meet the team building evolving intelligence',
    },
    news: {
      title: 'News',
  ...
  zh: {
    ...
    hero: {
      ...
      badge2: 'AIOS 平台',
      badge3: 'vibebara',
      feature1: 'Nemo One 一体机 · 本地智能算力',
      feature2: 'AIOS 平台 · 企业级 AI 应用开发与运营',
      feature3: 'vibebara · Skill 协作平台',
    },
    dailOverview: {
      ...
      statement: '——智能最终成为组织自己的能力，全链自研，交付一次，进化不止',
      linksAria: '探索更多 DAIL 内容',
      linkTechnology: '技术体系',
      linkTechnologyDesc: '深入探索 DAIL 的 AI 原生技术体系',
      linkCases: '行业实践',
      linkCasesDesc: '查看 DAIL 在真实行业中的落地实践',
      linkTeam: '团队',
      linkTeamDesc: '认识持续构建行业智能的 DAIL 团队',
    },
    news: {
      title: '新闻',
